...
class PropertyListFragment : BaseFragment<FragmentPropertyListBinding>() {
    ...
    override fun setupObservers() {
        // Use launchWhenStarted to avoid unnecessary work when the fragment is not visible
        ...
        viewLifecycleOwner.lifecycleScope.launchWhenStarted {
            // Collect filtered properties with a buffer to avoid excessive UI updates
            viewModel.filteredProperties
                .collect { properties ->
